...
class Ship(pygame.sprite.Sprite):
    def __init__(self, moving_x, moving_y):
        super().__init__(all_sprites)
        self.image = load_image('ship_one.jpg')
...
def start_game_player1():
    ...
    for i in range(10):
        for j in range(10):
            waves2 = AnimatedSprite(wave_inp, 9, 6, 77 + moving_x, 102 + moving_y)
            waves_dict[(j + 1, i + 1)] = waves2
            moving_x += 27
        moving_x = 27
        moving_y += 27
...
def start_game_player2():
    ...
    for i in range(10):
        for j in range(10):
            waves2 = AnimatedSprite(wave_inp, 9, 6, 403 + moving_x, 102 + moving_y)
            waves_dict[(j + 1, i + 1)] = waves2
            moving_x += 27
        moving_x = 27
        moving_y += 27
